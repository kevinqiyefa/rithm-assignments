      ...
      <div>
        <footer className="footer">
          <div className="container py-2 footer-content">
            <ul className="text-left pt-3 pl-0">
              <li className="footer-list ml-0">Home</li> |{' '}
              <li className="footer-list">Terms and Conditions</li> |{' '}
              <li className="footer-list">Privacy Policy</li> |{' '}
              <li className="footer-list">Collection Statement</li> |{' '}
              <li className="footer-list">Help</li> |{' '}
              <li className="footer-list">Manage Account</li>
            </ul>
